...
const AddTourists = () => {
    ...
    return (
            ...
            <div className="hero  bg-[url('https://i.ibb.co/w0kjxCs/victor-elvira-avalos-l-Iyu0a-Lb-MVI-unsplash.jpg')] bg-no-repeat bg-cover ">
                <Helmet>
                    <title>EuroQuest | Add Spot</title>
                </Helmet>
                <div className="hero-content flex-col p-3 rounded-xl">
                    
                    <div className="card shrink-0  shadow-2xl w-full bg-base-100">
                    <div className="text-center lg:text-left mb-5">
                        <h1 className="lg:text-5xl mt-5 text-center text-xl font-bold text-primaryNavy">Add Tourists Spot</h1>
                        ...
                        <form className="card-body flex flex-col gap-2 " onSubmit={handleAddSpot}>
                            ...
                            <div>
                                ...
                                <div className="form-control">
                                    ...
                                    <input type="text" name="user_name" placeholder="Enter user name" className="input input-bordered" required />
                                ...
                                <div className="form-control">
                                    ...
                                    <input type="text" name="population" placeholder="Enter the population" className="input input-bordered" required />
                                ...
                                <div className="form-control">
                                    ...
                                    <input type="text" name="photo" placeholder="https://example.com" className="input input-bordered" required />
                                ...
                                <div className="form-control">
                                    ...
                                    <input type="text" name="spot_name" placeholder="Enter spot name" className="input input-bordered" required />
                                ...
                                <div className="form-control">
                                    ...
                                    <input type="text" name="total_visitors" placeholder="Enter the number of visitors per year" className="input input-bordered" required />
                            ...
                            <div>
                                <div className="form-control">
                                    ...
                                    <input type="text" name="country_name" placeholder="Enter the country name" className="input input-bordered" required />
                                ...
                                <div className="form-control">
                                    ...
                                    <input type="text" name="location" placeholder="Enter the location name" className="input input-bordered" required />
                                ...
                                <div className="form-control">
                                    ...
                                    <textarea type="text" name="description" className="input input-bordered" required id="" placeholder="Enter some description" cols="30" rows="10"></textarea>
                                ...
                                <div className="form-control">
                                    ...
                                    <select
                                        ...
                                        name="seasonality"  // name attribute for the select field
                                        required
                                    >
                                ...
                                <div className="form-control">
                                    ...
                                    <input type="text" name="travel_time" placeholder="Enter travel time" className="input input-bordered" required />
